// esp_receiver_process_image.ino - Code for receiving and processing image signal
// This code interacts with Firebase to process incoming signals and control a servo motor.
